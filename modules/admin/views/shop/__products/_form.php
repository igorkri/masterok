...
<?php $form = ActiveForm::begin(['options' => ['enctype' => 'multipart/form-data']]); ?>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <?= $form->field($model, 'hit')->checkbox([ 'value' => '1', 'checked ' => false])->label('Хит товара'); ?>
            
            <?= $form->field($model, 'sale')->checkbox([ 'value' => '1', 'checked ' => FALSE])->label('Расспродажа товара'); ?>
            
            <?= $form->field($model, 'new')->checkbox([ 'value' => '1', 'checked ' => FALSE])->label('Новинка товара'); ?>

...
<?php
$this->title = $elektrik->title;

\Yii::$app->view->registerMetaTag([
    'name' => 'description',
    'content' => $elektrik->meta_desk
]);
            ...
            <div class="hero_section">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-5">
                        <img src="<?=$elektrik->img_slide?>" class="zoomIn wow animated" alt="<?=$elektrik->name?>" />
                    </div>

                    <div class="col-lg-5 col-sm-6">
                        <div class="top_left_cont zoomIn wow animated">
                            <h1 style="text-align: center"><?=$elektrik->title_slide?></h1>
                            <!--  Header contact  -->
...
<script type="application/ld+json">
    {
        ...
        "mainEntityOfPage": {
            "@type": "WebPage",
            "@id": "<?='https://masterok.pl.ua'?><?=$elektrik->link?>"
        },
        "headline": "Article headline",
        "image": [
            "<?='https://masterok.pl.ua'?><?=$elektrik->img_slide?>"
        ],
        ...
        "description": "<?=$elektrik->meta_desk?>"
    }
</script>
